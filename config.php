...
$THEME->scss = function($theme) {
    $THEME->scss = function($theme) {
        ...
        return theme_yinyang_get_main_scss_content($parentconfig);
    };
    return theme_yinyang_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_yinyang_get_extra_scss';
