...
namespace theme_yinyang\output\core;
...
use theme_yinyang\util\extras;

/**
 * Renderers to align Yin-Yang's course elements to what is expect
 *
 * @package    theme_yinyang
 * @copyright  2020 onwards Willian Mano {@link http://conecti.me}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
    ...
    protected function course_card_footer(core_course_list_element $course) {
        ...
        if (isloggedin()) {
            ...
            $content .= html_writer::link(new moodle_url('/course/view.php', ['id' => $course->id]),
                get_string('access', 'theme_yinyang'), ['class' => 'card-link btn btn-primary']);
